...
public class AddValid {
    public PackagedCommand addValid(String[] commandText) {
        if (commandText.length == 1 || commandText.length == 2) {
            if (commandText.length == 1) {
                ...
                return new PackagedCommand(commandText[0], args.toString());
            } else {
                ...
                if (flag) {
                    return new PackagedCommand(str[0], args.toString());
                }
                throw new IllegalArgumentException("Illegal arguments for command \"add\"!\n");
            }
        } else {
