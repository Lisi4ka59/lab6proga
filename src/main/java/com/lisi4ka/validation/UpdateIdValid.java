...
public class UpdateIdValid {
    public PackagedCommand updateIdValid(String[] commandText) {
    ...
    private PackagedCommand getPackagedCommand(String[] commandText, long id) {
        ...
        return new PackagedCommand(commandText[0], String.format("%d,%s", id, args.getCommandArguments()));
    }
}
